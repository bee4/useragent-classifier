...
class Baidu extends AbstractTaggedBot
{
    ...
    public function __construct($useragent)
    {
         ...
         *     Mobile Safari/533.1 (compatible; +http://www.baidu.com/search/spider.html)
         * Mozilla/5.0 (Windows; U; Windows NT 5.1; zh-CN; rv:1.9.2.8;baidu Transcoder) Gecko/20100722
