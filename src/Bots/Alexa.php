...
class Alexa extends AbstractTaggedBot
{
    ...
    public function __construct($useragent)
    {
         ...
         * Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; Trident/4.0; AlexaToolbar/amzni-3.0; GTB7.5;
         *     AskTbORJ/5.15.23.36191; .NET4.0C; .NET4.0E; AlexaToolbar/amzni-3.0; .NET CLR 2.0.50727;
         *     .NET CLR 3.0.4506.2152; .NET CLR 3.5.30729; MSIECrawler)
         */
